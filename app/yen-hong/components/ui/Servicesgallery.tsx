      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 h-auto md:h-[600px]">
        {services.map((item) => (
          <motion.div
            ...
            className={`
              relative group overflow-hidden rounded-3xl shadow-lg shadow-red-400/20 cursor-pointer
              h-[250px] md:h-full
              ${item.size} 
            `}
          >
            ...
            >
              ...
              <div className="w-full md:w-1/2 flex flex-col overflow-y-auto custom-scrollbar">
                <div className="p-6 md:p-10">
                  <h3 className="text-2xl md:text-3xl font-bold text-red-700 mb-4 leading-tight">
                    {selectedItem.title}
                  </h3>

                  {/* Wrapper teks agar jarak antar paragraf rapi */}
                  <div className="space-y-4 text-gray-600 leading-relaxed text-sm md:text-base">
                    <p className="font-semibold text-red-600/80">{selectedItem.desc}</p>
                  ...
                  <div className="mt-10 pt-6 border-t border-gray-100">
                    <button className="w-full bg-red-600 text-white px-8 py-4 rounded-2xl font-bold hover:bg-red-700 transition-all hover:shadow-lg active:scale-95">
                      Hubungi Kami
                    </button>
                  </div>
                </div>
