        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 max-w-6xl mx-auto">
            ...
            <div data-aos="fade-up" className="w-full lg:w-1/2 flex items-center justify-center px-4 md:px-0">
                <div className="w-full max-w-[280px] sm:max-w-[340px] lg:max-w-[420px] aspect-square relative group">
                    <div className="absolute inset-0 border-2 border-rose-100 rounded-[2rem] translate-x-3 translate-y-3 sm:translate-x-5 sm:translate-y-5 -z-10 transition-transform duration-500 group-hover:translate-x-2 group-hover:translate-y-2"></div>
            ...
            <div className="w-full lg:w-1/2">
                <h3 data-aos="fade-up" data-aos-delay="200" className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 uppercase">
                    Membangun Ekosistem <span className="text-rose-600">Pertanian Terintegrasi</span>
                </h3>
                <div className="space-y-6 ">
                    <p data-aos="fade-up" data-aos-delay="400" className="text-gray-600 leading-relaxed text-sm md:text-base">
                        <span className="font-bold text-rose-700">CV. Alpan Agro Jaya</span> adalah perusahaan yang bergerak di bidang agribisnis,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    {[
                        ...
                        <div key={i} className="flex gap-4">
                            <div data-aos="fade-up" data-aos-delay="800" className="flex-shrink-0 w-6 h-6 rounded-full bg-rose-100 flex items-center justify-center mt-1">
                ...
                <div className="grid grid-cols-2 gap-6 mt-4 border-t border-gray-100">
                    <div className="p-4">
                        <p data-aos="fade-up" data-aos-delay="1000" className="text-3xl font-bold text-rose-600">100%</p>
                    ...
                    <div className="p-4">
                        <p data-aos="fade-up" data-aos-delay="1400" className="text-3xl font-bold text-rose-600">Aceh-Papua</p>
