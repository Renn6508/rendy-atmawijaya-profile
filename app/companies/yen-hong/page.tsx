...
import Navbar from "../yen-hong/components/layout/Navbar";

import ServiceRibbon from "../yen-hong/components/section/ServiceRibbon";
import ServicesGallery from "../yen-hong/components/ui/Servicesgallery";
import CardContact from "../yen-hong/components/ui/ContactData";
import AboutContent from "../yen-hong/components/ui/AboutContent";
import Footer from "../yen-hong/components/layout/Footer";
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen md:h-screen flex items-center text-white z-20 overflow-visible py-20 md:py-0">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#dc2626] via-transparent to-transparent opacity-90" />
        </div>
      ...
      <section id="tentang-kami" className="pt-24 md:pt-24 pb-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center text-center mb-8 md:mb-14">
            ...
            <div className="mt-6 w-16 h-1 bg-red-600 rounded-full"></div>
          </div>
          <AboutContent />
        </div>
      </section>
      ...
      <section id="visi-misi" className="relative pt-24 pb-24 bg-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center mb-4 md:mb-8">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 uppercase tracking-tight">
              Visi & <span className="text-red-600">Misi Kami</span>
            </h2>
            <div className="mt-6 w-16 h-1 bg-red-600 rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            <div data-aos="fade-up" className="lg:col-span-5 bg-red-600 rounded-3xl p-8 md:p-12 text-white shadow-xl shadow-red-200 relative overflow-hidden group">
            ...
            <div data-aos="fade-up" data-aos-delay="100" className="lg:col-span-7 bg-white border-2 border-red-400 rounded-3xl p-8 md:p-12 shadow-sm relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                {[
                  ...
                  <div key={i} className="relative pl-6 border-l-2 border-red-100 hover:border-red-500 transition-colors group">
                    <span className="absolute -left-[2px] top-0 h-0 w-[2px] bg-red-500 group-hover:h-full transition-all duration-300"></span>
                    <h4 className="font-bold text-red-600 text-sm uppercase mb-1">{item.title}</h4>
      ...
      {/* <section id="partnership" className="pt-48 md:pt-32 pb-20 bg-red-700"> 
       <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row max-w-6xl mx-auto items-center">
            ...
            <div data-aos="fade-up" className="flex flex-col gap-4 justify-start -mt-35 md:w-1/2 p-4 w-full">
              <a
                ...
                className="group relative overflow-hidden bg-white p-10 rounded-3xl shadow-lg border border-red-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col items-center text-center"
              >
                {/* Dekorasi Background */}
                <div className="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-red-50 rounded-full transition-transform group-hover:scale-150 duration-500"></div>

                {/* Icon WhatsApp */}
                <div className="relative z-10 bg-red-100 p-5 rounded-2xl mb-6 group-hover:bg-red-500 transition-colors duration-300">
                  <svg
                    className="w-12 h-12 text-red-600 group-hover:text-white"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span className="bg-red-600 text-white px-8 py-3 rounded-full font-semibold group-hover:bg-red-700 transition-colors">
                  Kirim Pesan Sekarang
                </span>
              </a>
            </div>
            <div className="flex flex-col md:w-1/2 p-8">
              <h2 data-aos="fade-up" data-aos-delay="100" className="text-xs md:text-sm lg:text-base font-bold mb-2 text-red-600 uppercase tracking-wider mt-5">Contact</h2>
              <div className="flex flex-col gap-2 items-start">
                <h1 data-aos="fade-up" data-aos-delay="200" className="text-xl md:text-2xl lg:text-3xl font-bold mb-5 text-red-600 uppercase">Get in Touch</h1>
