    ...
    >
      <div className="container mx-auto px-6 lg:px-12 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="bg-white p-1 rounded-full group-hover:rotate-12 transition-transform duration-300 shadow-lg shadow-red-500/20">
            {/* <Leaf size={22} className="text-white" /> */}
            <Image src="/assets/images/logo-alpanagrojaya.png" alt="Logo" width={25} height={25} className="text-red-500" />
          </div>
          <span
          ...
          >
            YEN <span className="text-red-500">HONG</span>
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8 lg:gap-10">
          ...
          <div className="flex items-center gap-3 border-l border-gray-300/30 pl-8">
            <Link href="#kontak" className="bg-red-600 hover:bg-red-700 text-white px-5 py-2.5 rounded-lg font-bold uppercase text-[10px] lg:text-xs tracking-widest transition-all shadow-md active:scale-95">
              Hubungi Kami
            </Link>
            <button 
        ...
        <div className="flex flex-col p-8 gap-6">
          {navLinks.map((link) => (
            <Link
              key={link.name}
              href={link.href}
              className="text-red-900 font-bold uppercase text-sm tracking-[0.2em] border-b border-gray-50 pb-2"
          ...
          <div className="flex flex-col gap-3 pt-2">
            <Link href="#kontak" className="text-center bg-red-600 text-white py-4 rounded-xl font-bold text-xs uppercase tracking-widest shadow-lg">
              Hubungi Kami
            </Link>
            <button className="flex items-center justify-center gap-2 border border-red-100 text-red-600 py-3 rounded-xl font-bold text-xs uppercase tracking-widest">
