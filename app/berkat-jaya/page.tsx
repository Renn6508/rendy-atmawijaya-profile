...
import Navbar from "../berkat-jaya/components/layout/Navbar";

import ServiceRibbon from "../berkat-jaya/components/section/ServiceRibbon";
import ServicesGallery from "../berkat-jaya/components/ui/Servicesgallery";
import CardContact from "../berkat-jaya/components/ui/ContactData";
import AboutContent from "../berkat-jaya/components/ui/AboutContent";
import Footer from "../berkat-jaya/components/layout/Footer";
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen md:h-screen flex items-center text-white z-20 overflow-visible py-20 md:py-0">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#78350f] via-transparent to-transparent opacity-90" />
        </div>

        <div className="container mx-auto px-6 z-10 relative">
          <div className="max-w-3xl">
            {/* Ukuran teks adaptif: Kecil di HP, Besar di Desktop */}
            <h2 className="text-xs md:text-sm font-bold tracking-[0.2em] mb-4 text-amber-300 uppercase">
              PT. BERKAT JAYA
            </h2>
            <h1 className="text-3xl sm:text-4xl md:text-6xl text-white mb-6 leading-tight font-bold uppercase">
              ...
              <span className="text-amber-400">Bersama</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="#layanan" className="bg-amber-600 hover:bg-amber-700 text-white px-8 py-3 rounded font-bold uppercase tracking-wider transition-all text-sm">
                Layanan Kami
              </Link>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center text-center mb-8 md:mb-14">
            <div className="flex items-center gap-4 mb-3">
              <div className="w-8 h-[2px] bg-amber-500/50"></div>
              <span className="text-amber-600 font-bold tracking-[0.3em] text-xs uppercase">
                Who We Are
              </span>
              <div className="w-8 h-[2px] bg-amber-500/50"></div>
            </div>
            ...
            <div className="mt-6 w-16 h-1 bg-amber-600 rounded-full"></div>
          </div>
          <AboutContent />
        </div>
      </section>
      ...
      <section id="visi-misi" className="relative pt-24 pb-24 bg-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center mb-4 md:mb-8">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 uppercase tracking-tight">
              Visi & <span className="text-amber-600">Misi Kami</span>
            </h2>
            <div className="mt-6 w-16 h-1 bg-amber-600 rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            <div data-aos="fade-up" className="lg:col-span-5 bg-amber-600 rounded-3xl p-8 md:p-12 text-white shadow-xl shadow-amber-200 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-sm font-bold uppercase tracking-[0.2em] mb-4 text-amber-100">Visi Kami</h3>
            ...
            <div data-aos="fade-up" data-aos-delay="100" className="lg:col-span-7 bg-white border-2 border-amber-400 rounded-3xl p-8 md:p-12 shadow-sm relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                {[
                  ...
                  <div key={i} className="relative pl-6 border-l-2 border-amber-100 hover:border-amber-500 transition-colors group">
                    <span className="absolute -left-[2px] top-0 h-0 w-[2px] bg-amber-500 group-hover:h-full transition-all duration-300"></span>
                    <h4 className="font-bold text-amber-600 text-sm uppercase mb-1">{item.title}</h4>
      ...
      <section id="layanan" className="pt-24 md:pt-24 pb-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center text-center mb-4 md:mb-8">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 uppercase tracking-tight">
              Layanan <span className="text-amber-600">Unggulan</span>
            </h2>
            <div className="mt-6 w-16 h-1 bg-amber-600 rounded-full"></div>
          </div>
          <ServicesGallery />
      ...
      {/* <section id="partnership" className="pt-48 md:pt-32 pb-20 bg-amber-700"> 
       <div className="container mx-auto px-6">
      ...
      <section id="kontak" className="pt-24 md:pt-24 pb-20 bg-gray-100">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center text-center mb-4 md:mb-8">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 uppercase tracking-tight">
              Hubungi <span className="text-amber-600">Tim Kami</span>
            </h2>
            <div className="mt-6 w-16 h-1 bg-amber-600 rounded-full"></div>
          </div>
          <div className="flex flex-col md:flex-row max-w-6xl mx-auto items-center">
            ...
            <div data-aos="fade-up" className="flex flex-col gap-4 justify-start -mt-35 md:w-1/2 p-4 w-full">
              <a
                ...
                className="group relative overflow-hidden bg-white p-10 rounded-3xl shadow-lg border border-amber-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col items-center text-center"
              >
                {/* Dekorasi Background */}
                <div className="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-amber-50 rounded-full transition-transform group-hover:scale-150 duration-500"></div>

                {/* Icon WhatsApp */}
                <div className="relative z-10 bg-amber-100 p-5 rounded-2xl mb-6 group-hover:bg-amber-500 transition-colors duration-300">
                  <svg
                    className="w-12 h-12 text-amber-600 group-hover:text-white"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span className="bg-amber-600 text-white px-8 py-3 rounded-full font-semibold group-hover:bg-amber-700 transition-colors">
                  Kirim Pesan Sekarang
                </span>
              </a>
            </div>
            <div className="flex flex-col md:w-1/2 p-8">
              <h2 data-aos="fade-up" data-aos-delay="100" className="text-xs md:text-sm lg:text-base font-bold mb-2 text-amber-600 uppercase tracking-wider mt-5">Contact</h2>
              <div className="flex flex-col gap-2 items-start">
                <h1 data-aos="fade-up" data-aos-delay="200" className="text-xl md:text-2xl lg:text-3xl font-bold mb-5 text-amber-600 uppercase">Get in Touch</h1>
